...
The trigger and the call sit in the same place. Reading the button shows which function
...
sits on the element, available at once. That indirection is not needed here, and nothing
about the handler is hidden.
